        ...
        <div class="col-md-6" style="margin-top:10px;">
            <div class="col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="Name" class="form-control" placeholder="Name city" value=<?php echo
                        $city['Name'] ?>>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select name="CountryCode" class="form-control">
                        <?php
                        foreach ($cityListAll as $cityCode) {
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="Population" class="form-control" value=<?php echo $city['Population'] ?>
