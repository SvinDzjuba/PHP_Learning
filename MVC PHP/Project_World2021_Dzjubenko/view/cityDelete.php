        ...
        <div class="col-md-6" style="margin-top:10px;">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input readonly type="text" name="Code" class="form-control" placeholder="City name" maxlength=3
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <strong>Name *:</strong>
                    <input readonly type="text" name="Name" class="form-control" placeholder="CountryCode" value=<?php
                        echo $city['CountryCode'] ?> required>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <strong>Population *:</strong>
                    <input readonly type="text" name="Population" class="form-control" placeholder="Population"
                        value=<?php echo $city['Population'] ?> required>
                </div>
            </div>
